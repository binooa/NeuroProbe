...
for file in "${file_patterns1[@]}"; do
    ...
    gcc "$file" -Wall -Wno-unused-result -Wno-unknown-pragmas -Wfatal-errors -fPIC -pg -ggdb -march='skylake' -lm -O3  -fopt-info-vec-optimized -mavx2
